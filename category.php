     ...
     <section class="category__buttons">
        <div class="container category__buttons-container">
            <?php foreach($cateSection as $cates){
                ...
                if($cates['_id'] == $_GET['id']){?>
                <a href="category.php?id=<?= $cates['_id'] ?>" class="category__button" style="background: #ddd;"><?= $cates['_title'] ?></a>
                <?php }else{?>
...
<section class="posts">
    ...
    <?php 
    $cateGetId=$_GET['id'];
    $sql = "SELECT * FROM post WHERE _status='1' and _category_id='$cateGetId'";
